...
<div class="mega">
  ...
  <form id="registerForm" action="{{ route('user_register') }}" method="POST" enctype="multipart/form-data" class="register-form">
  @csrf
  ...
  <div class="form-left">
      ...
      <div id="qualificationsList">
        <div class="qual-item">
          <div class="qual-row">
            ...
            <button type="button" id="addQualificationBtn" class="btn-add icon-btn" aria-label="Add qualification">+</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div id="experiencesList">
        <div class="exp-item">
          <div class="exp-row">
            ...
            <!-- Add button moved to right of input, shows plus icon -->
            <button type="button" id="addExperienceBtn" class="btn-add icon-btn" aria-label="Add experience">+</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <fieldset>
      ...
      <div class="pair">
        ...
        <input type="text" id="perm_line2" name="permanent[line2]" placeholder="Apartment / Landmark (optional)" required>
      </div>
    ...
    <fieldset>
      ...
      <div class="pair">
        ...
        <input type="text" id="curr_line2" name="current[line2]" placeholder="Apartment / Landmark (optional)" required>
      </div>
  ...
  <aside class="form-right">
    <div class="profile-block">
      ...
      <input type="file" id="profile_picture" name="profile_picture" class="visually-hidden" accept="image/*" required>
